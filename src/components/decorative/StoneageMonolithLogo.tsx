...
export function StoneageMonolithLogo({
  ...
  if (variant === "mark") {
    ...
    return (
      <svg
        ...
        aria-hidden="true"
      >
        {/* Rotated Diamond Monolith Mark */}
        <polygon points="50,6 94,50 50,94 6,50" />
        <g transform="translate(50, 50) rotate(-45)">
          <text
            x="0"
            y="-14"
            fill="var(--color-charcoal, #161615)"
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="stoneageLightLeft" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id="stoneageLightRight" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#000000" stopOpacity="0" />
      ...
      <polygon points="42,0 183,0 183,260 42,390" fill="url(#stoneageLightLeft)" />

      {/* Right Light Shaft Column */}
      <polygon points="183,0 324,0 324,390 183,260" fill="url(#stoneageLightRight)" />
