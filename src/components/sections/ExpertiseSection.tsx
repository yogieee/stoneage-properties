...
export function ExpertiseSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      EXPERTISE_AREAS.forEach((_, i) => {
        if (i < EXPERTISE_AREAS.length - 1) {
      ...
      // Card 4: as next section (StatementBanner) rolls in over Card 4, Card 4 recedes and turns grey with no dead space!
      const lastCard = cardRefs.current[EXPERTISE_AREAS.length - 1];
      const lastOverlay = overlayRefs.current[EXPERTISE_AREAS.length - 1];
